...
/**
 * SunIcon component - typically used to represent light mode.
 * Renders an SVG icon depicting a sun.
 ...
 */
export const SunIcon = ({ className, style, ...rest }: IconProps): React.JSX.Element => (
  <svg
